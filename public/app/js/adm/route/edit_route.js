...
var KTEditRoute = (function () {
    ...
    return {
        init: function () {
            ...
            document
                .querySelectorAll(".edit-route-button")
                .forEach((button) => {
                    button.addEventListener("click", function () {
                        document.querySelector("#routeId").value =
                            this.dataset.id;
                        document.querySelector("#routeNameInput").value =
                            this.dataset.name;
                        document.querySelector("#routeHttpMethod").value =
                            this.dataset.http_req;
                        document.querySelector("#routeUriInput").value =
                            this.dataset.uri;
                        document.querySelector("#routeControllerInput").value =
                            this.dataset.controller;
                        document.querySelector("#routeActionInput").value =
                            this.dataset.action;
                        $("#routeHttpMethod")
                            .val(this.dataset.http_req)
                            .trigger("change");
                        url = this.href;
                    });
                });
            ...
            document
                .querySelectorAll(".middleware-checkbox")
                .forEach((checkbox) => {
                    checkbox.addEventListener("change", function () {
                        url = this.dataset.action;
